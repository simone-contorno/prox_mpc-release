...
Name:           ros-jazzy-prox-mpc-msgs
Version:        2.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS prox_mpc_msgs package

License:        Apache-2.0
URL:            https://index.ros.org/p/prox_mpc_msgs/#jazzy
...
%description
Message contract for the ProxMPC stack: Obstacle and ObstacleArray carry
tracked-obstacle id, position, velocity, radius, covariances, and sampled
predicted positions from the obstacle tracker to the Nav2 controller plugin;
SolverDiagnostics carries per-control-cycle NMPC/QP solver telemetry. Interface-
only package; no node.
