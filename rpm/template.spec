...
Name:           ros-jazzy-prox-mpc-benchmark
Version:        1.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS prox_mpc_benchmark package

License:        Apache-2.0
URL:            https://index.ros.org/p/prox_mpc_benchmark/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ffmpeg-free-devel
Requires:       libavcodec-free-devel
Requires:       libavformat-free-devel
Requires:       libavutil-free-devel
Requires:       libswscale-free-devel
Requires:       python%{python3_pkgversion}-numpy
Requires:       python%{python3_pkgversion}-yaml
Requires:       ros-jazzy-ament-index-python
Requires:       ros-jazzy-builtin-interfaces
Requires:       ros-jazzy-dwb-core
Requires:       ros-jazzy-dwb-critics
...
Requires:       ros-jazzy-prox-mpc-controller
Requires:       ros-jazzy-prox-mpc-demo
Requires:       ros-jazzy-prox-mpc-msgs
Requires:       ros-jazzy-prox-mpc-obstacle-tracker
...
Requires:       ros-jazzy-vector-pursuit-controller
...
%description
Scenario-driven benchmarking harness for the ProxMPC stack: a controller-
agnostic C++ live metrics node (cross-track / goal error + solver-diagnostics
tap) plus installed Python tooling to orchestrate the scenario x model x
controller x mode matrix, compute per-run metrics, and aggregate them. Reuses
the demo worlds/maps/models; owns the result artifacts (gitignored).
