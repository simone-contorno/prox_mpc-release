...
Name:           ros-jazzy-prox-mpc-obstacle-tracker
Version:        1.0.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS prox_mpc_obstacle_tracker package

License:        Apache-2.0
URL:            https://index.ros.org/p/prox_mpc_obstacle_tracker/#jazzy
...
%description
In-house 2D-lidar dynamic-obstacle detector and tracker for ProxMPC: a lifecycle
node that clusters a LaserScan, associates clusters to IMM (constant-velocity /
constant-turn-rate) Kalman tracks in a fixed frame, and publishes their position
and velocity as a prox_mpc_msgs/ObstacleArray. License-clean (no third-party
trackers).
